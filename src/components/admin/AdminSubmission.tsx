...
type AdminSubmissionData = Prisma.ModelMetadataGetPayload<{
  include: {
    ErsiliaIssue: true;
  };
}>;
...
interface AdminSubmissionProps {
  data: AdminSubmissionData;
}

export default function AdminSubmission({ data }: AdminSubmissionProps) {
  return (
        ...
        <CardHeader className="text-center p-0 mb-6">
          ...
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            {data.status === "DRAFT" ? (
              ...
              data.ErsiliaIssue?.issueUrl && (
                <a
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-sm text-gray-500"
                  href={data.ErsiliaIssue.issueUrl}
                >
